 ...
 * <ul>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getProposals <em>Proposals</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getSolution <em>Solution</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getCriteria <em>Criteria</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getActivity <em>Activity</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getAssessments <em>Assessments</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue()
 * @model
 * @generated
 */
public interface Issue extends Annotation, Checkable, WorkItem {
	 ...
	 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue_Proposals()
	 ...
	 * is '{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Solution#getIssue <em>Issue</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue_Solution()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getSolution
	 ...
	 * {@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Criterion}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue_Criteria()
	 ...
	 * {@link org.eclipse.emf.emfstore.internal.client.test.model.task.ActivityType}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue_Activity()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Issue#getActivity
	 ...
	 * {@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Assessment}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.emf.emfstore.internal.client.test.model.rationale.RationalePackage#getIssue_Assessments()
