...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.requirement.Workspace}
...
public class WorkspaceItemProvider extends UnicaseModelElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Workspace_type") : getString("_UI_Workspace_type")
			+ " " + label;
	}
