...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.organization.Group} object.
...
public class GroupItemProvider extends OrgUnitItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOrgUnitsPropertyDescriptor(object);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Group_type") : getString("_UI_Group_type") + " "
			+ label;
	}
