 ...
 * {@link org.eclipse.emf.emfstore.internal.client.test.model.profile.StereotypeAttribute} object. <!-- begin-user-doc
 * --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class StereotypeAttributeItemProvider extends UnicaseModelElementItemProvider implements
	 ...
	 * @generated
	 */
	public StereotypeAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((StereotypeAttribute) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeAttribute_type")
			: getString("_UI_StereotypeAttribute_type") + " " + label;
	}
