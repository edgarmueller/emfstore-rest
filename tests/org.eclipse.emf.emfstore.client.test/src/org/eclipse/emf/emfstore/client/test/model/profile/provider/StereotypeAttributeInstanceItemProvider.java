 ...
 * {@link org.eclipse.emf.emfstore.internal.client.test.model.profile.StereotypeAttributeInstance} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class StereotypeAttributeInstanceItemProvider extends UnicaseModelElementItemProvider implements
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addStereotypeInstancePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Stereotype Instance feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This adds a property descriptor for the Stereotype Attribute feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((StereotypeAttributeInstance) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeAttributeInstance_type")
			: getString("_UI_StereotypeAttributeInstance_type") + " " + label;
	}
