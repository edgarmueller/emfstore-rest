...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.Attachment}
 * object. <!--
...
public class AttachmentItemProvider extends UnicaseModelElementItemProvider implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferringModelElementsPropertyDescriptor(object);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Attachment_type")
