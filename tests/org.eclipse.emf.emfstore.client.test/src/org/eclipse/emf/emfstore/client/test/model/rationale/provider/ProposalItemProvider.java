...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Proposal} object.
...
public class ProposalItemProvider extends UnicaseModelElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Proposal_type") : getString("_UI_Proposal_type")
			+ " " + label;
	}
