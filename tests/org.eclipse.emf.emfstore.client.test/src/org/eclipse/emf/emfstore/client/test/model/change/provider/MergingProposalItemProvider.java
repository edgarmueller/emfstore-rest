...
import org.eclipse.emf.emfstore.client.test.model.rationale.provider.ProposalItemProvider;
import org.eclipse.emf.emfstore.internal.server.model.versioning.operations.OperationsFactory;

/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.change.MergingProposal}
...
public class MergingProposalItemProvider extends ProposalItemProvider implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChangePackage.Literals.MERGING_PROPOSAL__PENDING_OPERATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MergingProposal.class)) {
