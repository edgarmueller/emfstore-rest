 ...
 * {@link org.eclipse.emf.emfstore.internal.client.test.model.profile.StereotypeAttributeSimple} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class StereotypeAttributeSimpleItemProvider extends StereotypeAttributeItemProvider implements
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StereotypeAttributeSimple"));
	}
	...
	public String getText(Object object) {
		String label = ((StereotypeAttributeSimple) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeAttributeSimple_type")
			: getString("_UI_StereotypeAttributeSimple_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypeAttributeSimple.class)) {
