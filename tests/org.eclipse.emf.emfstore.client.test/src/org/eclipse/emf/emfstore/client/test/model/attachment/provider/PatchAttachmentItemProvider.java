 ...
 * {@link org.eclipse.emf.emfstore.internal.client.test.model.attachment.PatchAttachment} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PatchAttachmentItemProvider extends FileAttachmentItemProvider implements IEditingDomainItemProvider,
	...
	protected void addAppliedToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getResourceLocator(),
			getString("_UI_PatchAttachment_appliedTo_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_PatchAttachment_appliedTo_feature",
				"_UI_PatchAttachment_type"), AttachmentPackage.Literals.PATCH_ATTACHMENT__APPLIED_TO, true, false,
			true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PatchAttachment"));
	}
	...
	public String getText(Object object) {
		String label = ((PatchAttachment) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PatchAttachment_type")
			: getString("_UI_PatchAttachment_type") + " " + label;
	}
