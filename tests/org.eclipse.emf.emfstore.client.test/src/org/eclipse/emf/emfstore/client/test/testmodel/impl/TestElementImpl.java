 ...
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getReferences <em>References
 * </em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getContainedElements <em>
 * Contained Elements</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getReference <em>Reference
 * </em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getContainedElement <em>
 * Contained Element</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getOtherReference <em>Other
 * Reference</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getDescription <em>
 * Description</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getContainedElements2 <em>
 * Contained Elements2</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getContainer <em>Container
 * </em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getElementMap <em>Element Map
 * </em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getStringToStringMap <em>
 * String To String Map</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getElementToStringMap <em>
 * Element To String Map</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.internal.client.test.testmodel.impl.TestElementImpl#getStringToElementMap <em>
 * String To Element Map</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TestElementImpl extends EObjectImpl implements TestElement {
	...
	public EList<TestElement> getContainedElements2() {
		if (containedElements2 == null) {
			containedElements2 = new EObjectContainmentEList<TestElement>(TestElement.class, this,
				TestmodelPackage.TEST_ELEMENT__CONTAINED_ELEMENTS2);
		}
		...
		if (newContainer != eInternalContainer()
			...
			if (newContainer != null)
				msgs = ((InternalEObject) newContainer).eInverseAdd(this,
					TestmodelPackage.TEST_ELEMENT_CONTAINER__ELEMENTS, TestElementContainer.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case TestmodelPackage.TEST_ELEMENT__CONTAINER:
			return eInternalContainer().eInverseRemove(this, TestmodelPackage.TEST_ELEMENT_CONTAINER__ELEMENTS,
				TestElementContainer.class, msgs);
		}
