...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.internal.client.test.model.rationale.Criterion}
...
public class CriterionItemProvider extends UnicaseModelElementItemProvider implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Criterion_type") : getString("_UI_Criterion_type")
			+ " " + label;
	}
