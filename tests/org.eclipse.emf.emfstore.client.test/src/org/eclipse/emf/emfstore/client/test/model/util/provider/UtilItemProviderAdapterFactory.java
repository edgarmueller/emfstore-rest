...
import org.eclipse.emf.emfstore.client.test.model.util.util.UtilAdapterFactory;
...
public class UtilItemProviderAdapterFactory extends UtilAdapterFactory implements ComposeableAdapterFactory,
	...
	public Adapter createModelElementPathAdapter() {
		if (modelElementPathItemProvider == null) {
			modelElementPathItemProvider = new ModelElementPathItemProvider(this);
		}

		return modelElementPathItemProvider;
	}
	...
	public void dispose() {
		if (modelElementPathItemProvider != null)
			modelElementPathItemProvider.dispose();
	}
