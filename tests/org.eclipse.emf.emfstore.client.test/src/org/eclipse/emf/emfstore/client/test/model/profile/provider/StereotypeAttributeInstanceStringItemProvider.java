 ...
 * {@link org.eclipse.emf.emfstore.internal.client.test.model.profile.StereotypeAttributeInstanceString} object. <!--
...
public class StereotypeAttributeInstanceStringItemProvider extends StereotypeAttributeInstanceItemProvider implements
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StereotypeAttributeInstanceString"));
	}
	...
	public String getText(Object object) {
		String label = ((StereotypeAttributeInstanceString) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeAttributeInstanceString_type")
			: getString("_UI_StereotypeAttributeInstanceString_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypeAttributeInstanceString.class)) {
