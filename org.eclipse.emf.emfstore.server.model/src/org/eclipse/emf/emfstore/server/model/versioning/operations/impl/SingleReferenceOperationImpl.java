...
public class SingleReferenceOperationImpl extends ReferenceOperationImpl
	...
	public void apply(IdEObjectCollection project) {
		...
		if (modelElement == null) {
			modelElement = ((IdEObjectCollectionImpl) project)
					.getDeletedModelElement(getModelElementId());
		}

		EObject oldModelElement = project.getModelElement(getOldValue());
		if (oldModelElement == null) {
			oldModelElement = ((IdEObjectCollectionImpl) project)
					.getDeletedModelElement(getOldValue());
		}

		EObject newModelElement = project.getModelElement(getNewValue());
		if (newModelElement == null) {
			newModelElement = ((IdEObjectCollectionImpl) project)
					.getDeletedModelElement(getNewValue());
		}
