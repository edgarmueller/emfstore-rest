...
public interface IHistoryQueryFactory extends IEMFStoreFactory {
	 ...
	 * @return query
	 */
	IHistoryQuery rangeQuery(IPrimaryVersionSpec source, int upper, int lower,
			boolean allVersions, boolean incoming, boolean outgoing,
			boolean includeCp);
	 ...
	 * @return query
	 */
	IHistoryQuery pathQuery(IPrimaryVersionSpec source,
	 ...
	 * @return query
	 */
	IHistoryQuery modelelementQuery(IPrimaryVersionSpec source,
