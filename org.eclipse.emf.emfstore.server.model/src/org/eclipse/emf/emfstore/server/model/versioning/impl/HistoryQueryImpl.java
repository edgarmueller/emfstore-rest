 ...
 *   <li>{@link org.eclipse.emf.emfstore.server.model.versioning.impl.HistoryQueryImpl#isIncludeChangePackages <em>Include Change Packages</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.server.model.versioning.impl.HistoryQueryImpl#isIncludeAllVersions <em>Include All Versions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class HistoryQueryImpl extends EObjectImpl implements HistoryQuery {
	...
	public void setIncludeChangePackages(boolean newIncludeChangePackages) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VersioningPackage.HISTORY_QUERY__INCLUDE_CHANGE_PACKAGES, oldIncludeChangePackages, includeChangePackages));
	}
	...
	public void setIncludeAllVersions(boolean newIncludeAllVersions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VersioningPackage.HISTORY_QUERY__INCLUDE_ALL_VERSIONS, oldIncludeAllVersions, includeAllVersions));
	}
