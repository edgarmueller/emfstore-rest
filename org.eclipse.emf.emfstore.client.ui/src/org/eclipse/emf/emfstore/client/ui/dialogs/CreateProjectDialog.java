				...
				try {
					...
					if (session != null) {
						WorkspaceManager.getInstance().getCurrentWorkspace()
							.createRemoteProject(session, txtProjectName.getText(), txtProjectDesc.getText());
					} else {
					...
					String title = "Create Project failed!";
					MessageDialog.openError(getShell(), title, "Creating a project failed because access was denied!");
				} catch (EmfStoreException e) {
					String title = "Create Project failed!";
					MessageDialog.openError(getShell(), title, "Creating a project failed: " + e.getMessage());
				}
			}
