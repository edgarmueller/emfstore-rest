...
public class UIExportProjectSpaceController extends UIGenericExportImportController {
	...
	public IExportImportController getController() {
		return ExportControllers.getProjectSpaceExportController(projectSpace);
	}
