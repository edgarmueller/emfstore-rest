 ...
 * Contributors:
 ******************************************************************************/
package org.eclipse.emf.emfstore.internal.server.internal.startup;
...
public final class ExtensionManager {
	...
	public static void notifyStartupListener(EList<ProjectHistory> projects) {
		for (ExtensionElement element : new ExtensionPoint("org.eclipse.emf.emfstore.internal.serverxxx.startuplistener", true)
	...
	public static void notifyPostStartupListener(ServerSpace serverspace, AccessControlImpl accessControl,
		...
		for (ExtensionElement element : new ExtensionPoint("org.eclipse.emf.emfstore.internal.serverxxx.poststartuplistener", true)
			.getExtensionElements()) {
			try {
