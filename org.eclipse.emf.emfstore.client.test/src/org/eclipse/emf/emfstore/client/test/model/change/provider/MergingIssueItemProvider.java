 ...
 * Contributors:
 ******************************************************************************/
package org.eclipse.emf.emfstore.client.test.model.change.provider;
...
import org.eclipse.emf.emfstore.client.test.model.rationale.provider.IssueItemProvider;
import org.eclipse.emf.emfstore.server.model.versioning.VersioningFactory;

/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.client.test.model.change.MergingIssue}
...
public class MergingIssueItemProvider extends IssueItemProvider implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChangePackage.Literals.MERGING_ISSUE__BASE_VERSION);
			childrenFeatures.add(ChangePackage.Literals.MERGING_ISSUE__TARGET_VERSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ChangePackage.Literals.MERGING_ISSUE__BASE_VERSION,
			VersioningFactory.eINSTANCE.createPrimaryVersionSpec()));

		newChildDescriptors.add(createChildParameter(ChangePackage.Literals.MERGING_ISSUE__TARGET_VERSION,
			VersioningFactory.eINSTANCE.createPrimaryVersionSpec()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == ChangePackage.Literals.MERGING_ISSUE__BASE_VERSION
			|| childFeature == ChangePackage.Literals.MERGING_ISSUE__TARGET_VERSION;
