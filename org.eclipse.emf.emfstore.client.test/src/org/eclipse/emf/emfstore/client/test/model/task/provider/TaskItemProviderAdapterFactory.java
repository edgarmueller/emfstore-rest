...
import org.eclipse.emf.emfstore.client.test.model.task.util.TaskAdapterFactory;
...
public class TaskItemProviderAdapterFactory extends TaskAdapterFactory implements ComposeableAdapterFactory,
	...
	public Adapter createActionItemAdapter() {
		if (actionItemItemProvider == null) {
			actionItemItemProvider = new ActionItemItemProvider(this);
		}

		return actionItemItemProvider;
	}
