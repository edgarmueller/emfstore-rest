 ...
 * @generated
 */
public class OrganizationSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case OrganizationPackage.USER: {
			...
			if (result == null)
				result = caseUnicaseModelElement(user);
			if (result == null)
		...
		case OrganizationPackage.ORG_UNIT: {
			...
			if (result == null)
				result = caseUnicaseModelElement(orgUnit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case OrganizationPackage.GROUP: {
			...
			if (result == null)
				result = caseUnicaseModelElement(group);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Org Unit</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
