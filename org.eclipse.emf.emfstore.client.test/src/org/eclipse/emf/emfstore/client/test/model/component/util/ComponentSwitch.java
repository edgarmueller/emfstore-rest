...
public class ComponentSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentPackage.COMPONENT: {
			...
			if (result == null)
				result = caseUnicaseModelElement(component);
			if (result == null)
		...
		case ComponentPackage.COMPONENT_SERVICE: {
			...
			if (result == null)
				result = caseUnicaseModelElement(componentService);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ComponentPackage.DEPLOYMENT_NODE: {
			...
			if (result == null)
				result = caseUnicaseModelElement(deploymentNode);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Deployment Node</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc
	 * -->
	 * 
	 * @param object the target of the switch.
