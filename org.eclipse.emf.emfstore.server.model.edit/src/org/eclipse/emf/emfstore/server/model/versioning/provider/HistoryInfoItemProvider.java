 ...
 * {@link org.eclipse.emf.emfstore.server.model.versioning.HistoryInfo} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class HistoryInfoItemProvider extends ItemProviderAdapter implements
	...
	protected void addPrimerySpecPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_HistoryInfo_primerySpec_feature",
						"_UI_HistoryInfo_type"),
				VersioningPackage.Literals.HISTORY_INFO__PRIMERY_SPEC, true,
	...
	protected void addLogMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_HistoryInfo_logMessage_feature",
						"_UI_HistoryInfo_type"),
				VersioningPackage.Literals.HISTORY_INFO__LOG_MESSAGE, true,
				false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__NEXT_SPEC);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__PREVIOUS_SPEC);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__MERGED_FROM);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__MERGED_TO);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__TAG_SPECS);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__VERSION_PROPERTIES);
			childrenFeatures
					.add(VersioningPackage.Literals.HISTORY_INFO__CHANGE_PACKAGE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/HistoryInfo.png"));
	}
