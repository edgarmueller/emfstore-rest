 ...
 * {@link org.eclipse.emf.emfstore.server.model.versioning.Version} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class VersionItemProvider extends ItemProviderAdapter implements
	...
	protected void addNextVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_nextVersion_feature", "_UI_Version_type"),
				VersioningPackage.Literals.VERSION__NEXT_VERSION, true, false,
				true, null, null, null));
	}
	...
	protected void addPreviousVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_previousVersion_feature",
						"_UI_Version_type"),
				VersioningPackage.Literals.VERSION__PREVIOUS_VERSION, true,
	...
	protected void addAncestorVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_ancestorVersion_feature",
						"_UI_Version_type"),
				VersioningPackage.Literals.VERSION__ANCESTOR_VERSION, true,
				false, true, null, null, null));
	}
	...
	protected void addBranchedVersionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_branchedVersions_feature",
						"_UI_Version_type"),
				VersioningPackage.Literals.VERSION__BRANCHED_VERSIONS, true,
				false, true, null, null, null));
	}
	...
	protected void addMergedToVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_mergedToVersion_feature",
						"_UI_Version_type"),
				VersioningPackage.Literals.VERSION__MERGED_TO_VERSION, true,
				false, true, null, null, null));
	}
	...
	protected void addMergedFromVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Version_mergedFromVersion_feature",
						"_UI_Version_type"),
				VersioningPackage.Literals.VERSION__MERGED_FROM_VERSION, true,
				false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(VersioningPackage.Literals.VERSION__PROJECT_STATE);
			childrenFeatures
					.add(VersioningPackage.Literals.VERSION__PRIMARY_SPEC);
			...
			childrenFeatures
					.add(VersioningPackage.Literals.VERSION__LOG_MESSAGE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Version"));
	}
